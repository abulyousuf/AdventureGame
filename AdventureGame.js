...
let firstVisit = true; // Track if it's the player's first visit
...
if (currentLocation === "village") {
  ...
  if (firstVisit) {
    console.log(
      "\nVillage: 'Welcome, adventurer! Rumour has it there's a dragon in the mountains...'"
    );
  ...
  console.log("\n=== BLACKSMITH ===");
  console.log(
    "The heat from the forge fills the air. Weapons and armour line the walls."
  );
  console.log("\nWhere would you like to go?");
